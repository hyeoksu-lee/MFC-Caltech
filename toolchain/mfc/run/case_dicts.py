...
SIMULATION.update({
    ...
    'dt': ParamType.REAL,
    'dtau': ParamType.REAL,
    'dts_cfl': ParamType.REAL,
    'dts_r_tol': ParamType.REAL,
    'dts_a_tol': ParamType.REAL,
    'dts_iter_max': ParamType.INT,
    'dts_cutoff': ParamType.REAL,
    't_step_start': ParamType.INT,
