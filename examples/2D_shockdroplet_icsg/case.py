...
xend = 12 * D  # right domain boundary
ybeg = 0.0  # bottom domain boundary
yend = 2 * D  # top domain boundary
y_a = -1.5 * D  # y-grid stretching parameter
y_b = 1.5 * D  # y-grid stretching parameter
a_y = 2.0  # y-grid stretching parameter
