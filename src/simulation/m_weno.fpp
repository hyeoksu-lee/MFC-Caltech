...
contains
    ...
    subroutine s_weno(v_vf, vL_rs_vf_x, vL_rs_vf_y, vL_rs_vf_z, vR_rs_vf_x, vR_rs_vf_y, vR_rs_vf_z, &
        ...
        real(wp), dimension(0:weno_num_stencils) :: omega_central, omega_upwind
        ...
        elseif (weno_order == 3) then
            ...
            #:endfor
        elseif (weno_order == 5 .and. .not. wcns_ld) then
            #:for WENO_DIR, XYZ in [(1, 'x'), (2, 'y'), (3, 'z')]
                if (weno_dir == ${WENO_DIR}$) then
            ...
            #:endfor
        elseif (weno_order == 5 .and. wcns_ld) then
            #:for WENO_DIR, XYZ in [(1, 'x'), (2, 'y'), (3, 'z')]
                if (weno_dir == ${WENO_DIR}$) then
                        ...
                        do k = is2_weno%beg, is2_weno%end
                            do j = is1_weno%beg, is1_weno%end
                                ...
                                do i = 1, v_size
                                    ...
                                    !     write(98,*) "L", vL_rs_vf_${XYZ}$ (j, k, l, i), poly(0), poly(1), poly(2), poly(3), beta(0), beta(1), beta(2), beta(3), alpha(0), alpha(1), alpha(2), alpha(3), omega(0), omega(1), omega(2), omega(3)
                                    ! end if
                                    ...
                                    ! if (j == 150 .and. i == 1) then
                                    !     write(99,*) "R", vR_rs_vf_${XYZ}$ (j, k, l, i), poly(0), poly(1), poly(2), poly(3), beta(0), beta(1), beta(2), beta(3), alpha(0), alpha(1), alpha(2), alpha(3), omega(0), omega(1), omega(2), omega(3)
                                    ! end if
