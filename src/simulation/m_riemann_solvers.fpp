                        ...
                        do k = is2%beg, is2%end
                            do j = is1%beg, is1%end
                                ...
                                if (avg_state == 2) then
                                    ...
                                    if (qL_prim_rs${XYZ}$_vf(j, k, l, E_idx + num_fluids) < small_alf) then
                                    ...
                                    if (qR_prim_rs${XYZ}$_vf(j + 1, k, l, E_idx + num_fluids) < small_alf) then
                                    ...
                                    if ((.not. f_approx_equal(ptilde_L, ptilde_L)) .or. (.not. f_approx_equal(ptilde_R, ptilde_R))) then
                                      print *, pres_L, PbwR3Lbar, R3Lbar, rho_L, R3V2Lbar
                                      print *, pres_R, PbwR3Rbar, R3Rbar, rho_R, R3V2Rbar
